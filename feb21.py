#Today I learned:myName = input("What's your name?: ")
...
print(f"Hello {myName}! Your and your friend {myFriends} go to {myFavouriteRestraunt} again. You eat {myFavouriteFood} as you walk down the streets you see something you hate {iHate}")
